    ...
    <section id="primary-area">
		<div class="cal-container">
			...
			<div class="height-container">
				<h2>Height :</h2>
				<input type="text" maxlength="5" v-model="h">
                <!-- 用 v-model 雙向指向 input, 省略 onclick, attribute -->
				<h2>cm</h2>
			</div>
			<div class="bw-container">
				<h2>Weight :</h2>
				<input type="text" maxlength="5" v-model="w">
                <!-- 用 v-model 雙向指向 input, 省略 onclick, attribute -->
				<h2>kg</h2>
			</div>
			...
			<div class="result-area">
				<p class="result-title">Surprise! 跟你說你的BMI是...</p>
    ...
    methods: {
        caculate() {
            ...
            if (isNaN(parseInt(this.h)) || isNaN(parseInt(this.w))) {
                    ...
                    var bmi = (this.w / ((this.h * this.h)/10000)).toFixed(2);
                ...
                if (this.bmi >= 35) {
					...
					console.log('中度肥胖' + "<br>" + "<br>" + 'Do 運動 or do not ! 願原力指引你的體重 !!');
				} else if (27 <= this.bmi) {
					console.log('輕度肥胖' + "<br>" + "<br>" + '現在! 立刻! 跑起來! Do it ! Just !! Do it !!!');
				} else if (24 <= this.bmi) {
					console.log('過重' + "<br>" + "<br>" + '變胖真是太無情啦, 史丹利 !! (誰 ?)');
				} else if (18.5 <= this.bmi) {
					console.log('正常範圍' + "<br>" + "<br>" + '汝心汝行澄如明鏡，所作所為皆為健康 !!');
				} else {
					console.log('體重過輕' + "<br>" + "<br>" + '哇! 太瘦了吧！ 沒事多吃多健康 !!!');
                }
